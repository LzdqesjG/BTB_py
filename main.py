...
# 字体加载：直接从 Windows 字体目录加载（避开 pygame SysFont initsysfonts_win32 的兼容性问题）
def _load_cjk_font(size, bold=False):
    ...
    if bold:
        # 优先粗体
        candidates = [r"C:\Windows\Fonts\msyhbd.ttc", r"C:\Windows\Fonts\simhei.ttf"] + candidates
